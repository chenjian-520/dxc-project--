...
public class StudentController {
	...
	@RequestMapping(value = "/user.do", method = RequestMethod.POST,produces="text/html;charset=UTF-8")
	public String login(HttpServletRequest request, Model model) throws Exception {
		...
		List<Student> query1 = studentService.getAllStudent();
		// 验证用户名密码
		for (Student a : query1) {
			if (String.valueOf(a.getId()).equals(id)&&String.valueOf(a.getAge()).equals(age)&&a.getName().equals(name)&&a.getSex().equals(sex)) {
				Student student= new Student();
				student.setId(a.getId());
				student.setName(a.getName());
				student.setSex(a.getSex());
				student.setAge(a.getAge());
	...
	public String insertStudent(Student student,Model model) throws Exception {
